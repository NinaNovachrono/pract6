const cargarTipos=async()=>{
    try {
        const url ="https://api.allorigins.win/raw?url=http://201.140.116.237/services/tipo.php"
...
const cargarVentas=async()=>{
    try {
        const url = "https://api.allorigins.win/raw?url=http://201.140.116.237/services/ventas.php";
        //url ="ventas.json";
        await axios
        .get(url)
        .then((res)=>{
